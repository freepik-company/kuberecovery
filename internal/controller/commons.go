...
const (
	...
	recoveryConfigNotExistsInPoolError = "error recoveryConfig %s not exists in the pool"
	...
	recoveryConfigChangedMessage        = "RecoveryConfig changed, updating %s key in the pool with the new values for informers"
